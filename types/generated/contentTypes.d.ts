...
export interface ApiTradeTrade extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    emotions: Schema.Attribute.Enumeration<
      ['confident', 'nervous', 'greedy', 'fearful', 'calm', 'frustrated']
    >;
    entry_price: Schema.Attribute.Decimal & Schema.Attribute.Required;
    exit_price: Schema.Attribute.Decimal;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::trade.trade'> &
      Schema.Attribute.Private;
    notes: Schema.Attribute.Text;
    portfolio_percentage: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    result: Schema.Attribute.Decimal;
    status: Schema.Attribute.Enumeration<['open', 'closed', 'cancelled']> &
    ...
    take_profit: Schema.Attribute.Decimal;
